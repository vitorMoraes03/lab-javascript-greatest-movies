...
// Iteration 5: Ordering by year - Order by year, 
//ascending (in growing order). And if same year, then alphabetically.
//Dont change original array, return a new array.
...
//sort alphabetically
//return onlu title of first 20 movies
...
// Exemplo abaixo dado em aula, uma maneira de alterar e criar novas chaves
// com Spread Operator

// const dadosSalvos = movie.map((currentMovie) => {
//   return { ...currentMovie, adult: true, novaChave: 'oioi'};
// })

function turnHoursToMinutes(moviesArray) {
  // let arrayCopy = JSON.parse(JSON.stringify(moviesArray));
  let newArray = moviesArray.map(element => {
    return element.duration.replace(/[^0-9]/g, '');;
  })
  return newArray;
}
